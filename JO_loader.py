...
mesh_paths = (r"/Users/numio/Desktop/FYP_Materials/code/ostos/Data/mesh/L0.05_vf0.3/h0.0002",
              r"/Users/numio/Desktop/FYP_Materials/code/ostos/Data/mesh/L0.05_vf0.5/h0.0002")

curve_paths = (r"/Users/numio/Desktop/FYP_Materials/code/ostos/Data/L0.05_vf0.3/h0.0002",
               r"/Users/numio/Desktop/FYP_Materials/code/ostos/Data/L0.05_vf0.5/h0.0002")


def load_fracture_mesh_macrocurve( curve_paths, mesh_paths,
                 n_train, n_tests,
    ...
    for mesh_path, curve_path in zip(mesh_paths, curve_paths):
        ...
        for folder in os.listdir(curve_path):
            ...
            # out curves from curve path directories
            data_s = glob.glob(f'{curve_path}/{folder}/*.std')

            # to normalise each curve dataset:
            for data in data_s:
